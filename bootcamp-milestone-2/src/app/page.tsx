        ...
        <div className="about">
          ...
          <div className="about-text">
            <p>
              ...
              CalPoly&apos;s Computer Engineering program, but by my sophomore
              year I discovered I have no such passion for Electrical
              Engineering, and that I only wanted to pursue software. I have
              since changed my major to Computer Science, made Dean&apos;s List
              honors three quarters in a row, and secured my first internship at
              OpenPark, a small startup out of LA, and joined Hack4Impact Cal
              Poly as a software developer. Welcome to my website!
            </p>
          </div>
        </div>
        {blogData
