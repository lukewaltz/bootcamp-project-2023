    ...
    <Link href="/blog"><div>{blogs.map(blog => 
      ...
      <div className="blog-entry">
        <div className="blog-image-set">
          <Image className="blog-image" src="/wetsuit.jpg" width={200} height={200} alt="wetsuit" />
          <Image className="blog-image" src="/surf_duo.jpg" width={200} height={200} alt="surf" />
          <Image className="blog-image" src="/morro_golf.jpg" width={200} height={200} alt="golf" />
        </div>
        ...
        <p className="blog-caption">
          ...
          tailgate at my fraternitys main house. After a disappointing CalPoly
      ...
      <div className="blog-entry">
        <div className="blog-image-set">
          <Image className="blog-image" src="/dubrovnik2.jpg" width={200} height={200} alt="wetsuit" />
          <Image className="blog-image" src="/split2.jpg" width={200} height={200} alt="surf" />
          <Image className="blog-image" src="/dubrovnik.jpg" width={200} height={200} alt="golf" />
        </div>
        ...
        <p className="blog-caption">
          ...
          new flat for her first year of grad school at Kings College! We then
